...
const CHANGELOGS = [
  { ver: 'v2.6.7', date: '2026-05-18', items: ['photoCats = egyetlen forrás (TYPES megszűnt)', 'Duplikált kategóriák javítva', 'Szín szinkronizálva settings ↔ kártyák', 'Új kategória azonnal megjelenik a kártya formon'] },
