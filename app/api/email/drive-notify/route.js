  ...
  try {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto">
        <div style="background:#1f4d3f;padding:16px 20px;border-radius:8px 8px 0 0">
        ...
        <div style="background:#f9f7f4;padding:20px;border-radius:0 0 8px 8px;border:1px solid #e4e0d9">
          ...
          <a href="${driveLink}" style="display:inline-block;background:#1f4d3f;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:700;font-size:14px">📁 Drive-Link öffnen</a>
