    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#2a2a28">
          ...
          ${travelTight ? '<p style="background:#fffbf0;border:1px solid #f0d9a8;border-radius:8px;padding:10px;color:#6b6b6e"><strong>⚠ Hinweis:</strong> Wegen der Anfahrt von einem vorherigen Termin kann sich die Ankunft um wenige Minuten verschieben.</p>' : ''}
