...
>
      ...
      {/* ── AI PANEL ── */}
      {aiOpen && (
        <div style={{ position:'fixed', bottom:20, right:20, width:380, maxWidth:'calc(100vw - 40px)', height:'min(70vh, 620px)', maxHeight:'calc(100vh - 96px)', background:'var(--bg2)', border:'0.5px solid var(--border)', borderRadius:16, zIndex:310, display:'flex', flexDirection:'column', boxShadow:'0 12px 40px rgba(120,90,30,.16)', overflow:'hidden' }}>
