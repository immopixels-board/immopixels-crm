...
const CHANGELOGS = [
  { ver: 'v5.1.48', date: '2026-06-21', items: ['Rentabilität pro Fotoshooting komplett neu (Vollkosten/netto): Bildbearbeitung kommt jetzt aus der importierten Bildbearbeiter-Rechnung (Positionen nach Kundenname summiert, nicht mehr Ø). Fahrtkosten pro Fahrer getrennt aufteilbar (ich/Mitarbeiter, eigene km-Sätze). Gemeinkosten hybrid: Personal (Bank) + Fixkosten amortisiert + sonstige Betriebskosten, nach Umsatzanteil umgelegt. Steuer aufgeteilt in Gewerbesteuer (Hebesatz) + Einkommensteuer (Grenzsatz, §35-Anrechnung). Neuer Import „🎨 Bildbearbeiter-Rechnung" (PDF → KI-Parser → Positionen, Kunde + Shooting-Monat erkannt).'] },
  { ver: 'v5.1.47', date: '2026-06-21', items: ['Kategorien erweiterbar: Unterkategorien (Versicherung › Kfz/Kranken/Drohne …), neue Hauptkategorien Leasing & Abo (Internet/Telefon/Software-Abo/Streaming). Über „🏷️ Kategorien" eigene hinzufügen — überall in den Listen + von der KI genutzt.', 'Neuer Tab „🧾 Abgleich": Monatsansicht, die jede Bank-Belastung mit dem passenden Beleg verknüpft. Gleicher Betrag = Vorschlag (1 Klick übernehmen). Fehlt ein Beleg: vorhandenen zuordnen ODER direkt hochladen (mit KI-Kategorie, wird automatisch verknüpft). Quote + offener Betrag sichtbar; „Belege ohne Buchung" separat.'] },
  { ver: 'v5.1.46', date: '2026-06-21', items: ['Rentabilität neu: Kunde + Rechnung per Dropdown wählen → sofort Kalkulation. Bildbearbeitung = Ø Bilder × Preis (50 × 0,70 €). km aus den Rechnungspositionen (Fahrtenbuch), Fahrer ich/Mitarbeiter mit eigenem km-Satz. Fixkosten: „Aus Kontoauszug erkennen (KI)" findet Abos/Versicherungen automatisch (Generali, PayPal-Surfshark, Mawacon …), schlägt Kategorie + Intervall vor und legt Kategorie-Regeln + Fixkosten an.'] },
  { ver: 'v5.1.45', date: '2026-06-21', items: ['Billomat-Kunden-Import jetzt auswählbar: Rechnungen → Import → „Billomat-Kunden laden" zeigt erst die Liste (mit Kundennummer/Ort/E-Mail), bereits vorhandene deaktiviert — dann nur die ausgewählten importieren (nicht mehr alle automatisch).'] },
